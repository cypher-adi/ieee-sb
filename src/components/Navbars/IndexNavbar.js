		...
		<Navbar className={classnames('fixed-top', navbarColor)} expand="lg">
			<Container>
				...
				<Collapse className="justify-content-end" navbar isOpen={navbarCollapse}>
					<Nav navbar>
						<NavItem>
							<NavLink data-placement="bottom" href="/about">
								About Us
							</NavLink>
						</NavItem>
						<NavItem>
							<NavLink data-placement="bottom" href="/events">
								Events
							</NavLink>
						</NavItem>
						<NavItem>
							<NavLink data-placement="bottom" href="/team">
								Team
							</NavLink>
						</NavItem>
						<NavItem>
							<NavLink data-placement="bottom" href="/gallery">
								Gallery
							</NavLink>
						</NavItem>
						<NavItem>
